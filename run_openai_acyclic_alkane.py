# -*- coding: utf-8 -*-
"""
python run_ei_ms_api.py \
  --input_file ./data/acyclic_alkane.json \
  --output_file ./outputs/acyclic_alkane_ei_results.json \
  --api_key xx \
...
python run_api_acyclic_alkane.py \
  --input_file ./difference_types_SMILES/acyclic_alkane.json \
  --output_file ./output/acyclic_alkane_ei_results.json \
  --model gpt-4.1 \
  --max_tokens 4096 \
  --temperature 0.0

python run_openai_acyclic_alkane.py --input_file ./difference_types_SMILES/acyclic_alkane.json --output_file ./outputs/openai_gpt41_test_results.json --model gpt-4.1 --max_tokens 4096 --temperature 0.0
"""
